...
public class AddMinyanFragment extends Fragment implements View.OnClickListener {
  ...
  public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    spinnerPrayType.setAdapter(
        new ArrayAdapter<>(getContext(), R.layout.support_simple_spinner_dropdown_item,
            prayTypeNames));
    ...
    spinnerRelativeTimeType.setAdapter(
        new ArrayAdapter<>(getContext(), R.layout.support_simple_spinner_dropdown_item,
            relativeTimeTypeNames));
  }
      ...
      source.updateSynagogue(mSynagogue, new ResponseListener<Void>() {
        ...
        public void onResponse(Void response) {
          Toast.makeText(getContext(),
              getContext().getResources().getString(R.string.seccess_add_minyan),
