...
public class SearchMinyanFragment extends Fragment implements
    ...
    //SearchMinyanFragment searchMinyanFragment; = new SearchMinyanFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //   searchMinyanFragment = new SearchMinyanFragment();
    }
    ...
    private void searchSynagogues() {
        String synagogue = etSearchAddress.getText().toString();
        ...
        switch (v.getId()) {
            case R.id.search_minyan_btn_search:
                ...
                fragmentManager.beginTransaction()
                        .add(R.id.MA_container,getInstance())
