...
public class Alerts {
  ...
  public static void noInternet(final Activity activity,
      final OnCancelDialogListener onCancelDialogListener) {
    if (!noInternetAlertShowing) {
      ...
      new AlertDialog.Builder(activity)
          ...
          .setPositiveButton(activity.getResources().getString(R.string.open_internet_settings),
              new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                  ...
                  Intent chooserIntent = Intent
                      .createChooser(new Intent(Settings.ACTION_WIRELESS_SETTINGS),
                          activity.getResources().getString(R.string.select_settings));
                  chooserIntent.putExtra(Intent.EXTRA_INITIAL_INTENTS,
                      new Intent[]{new Intent(Settings.ACTION_WIFI_SETTINGS)});
                  // intent.setClassName("com.android.phone", "com.android.phone.NetworkSetting");
                  activity
                      .startActivityForResult(chooserIntent, ACTION_CODE_OPEN_INTERNET_SETTINGS);
                  dialog.cancel();
                }
              })
  ...
  public static void noGPS(final Activity context,
      final OnCancelDialogListener onCancelDialogListener) {
    if (!noGPSAlertShowing) {
      ...
      new AlertDialog.Builder(context)
          ...
          .setPositiveButton(context.getResources().getString(R.string.open_internet_settings),
              new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
