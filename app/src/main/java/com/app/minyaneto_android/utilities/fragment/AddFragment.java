...
public class AddFragment {
  ...
  public AddFragment(Fragment fragment, int containerId, String tag, boolean popBackStack,
      String tagToBackStack, Action action) {
  ...
  public AddFragment(Fragment fragment, int containerId, String tag, String tagToBackStack,
      Action action) {
    this.fragment = fragment;
    this.containerId = containerId;
    this.tag = tag;
