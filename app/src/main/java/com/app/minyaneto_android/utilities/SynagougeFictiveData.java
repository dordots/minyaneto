...
public class SynagougeFictiveData {
    public static ArrayList<Synagogue> getFictiveSynagouges(LatLng location) {
        ...
        s.addMinyan(new Minyan("11", PrayType.AFTER_NOON, new ExactTime(16, 30), PrayDayType.SUNDAY));
        s.addMinyan(new Minyan("12", PrayType.EVENING, new ExactTime(17, 30), PrayDayType.SUNDAY));
        s.addMinyan(new Minyan("13", PrayType.MORNING, new ExactTime(8, 00), PrayDayType.SUNDAY));
        synagogues.add(s);
        ...
        s.addMinyan(new Minyan("11", PrayType.AFTER_NOON, new ExactTime(13, 30), PrayDayType.SUNDAY));
        synagogues.add(s);
        ...
        s.addMinyan(new Minyan("11", PrayType.AFTER_NOON, new ExactTime(16, 00), PrayDayType.SUNDAY));
        synagogues.add(s);
        ...
        s.addMinyan(new Minyan("11", PrayType.AFTER_NOON, new ExactTime(12, 30), PrayDayType.SUNDAY));
        synagogues.add(s);
