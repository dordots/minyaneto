...
public class SynagougeFictiveData {
    public static ArrayList<Synagogue> getFictiveSynagouges(LatLng location) {
        ...
        s.addMinyan(new Minyan("1", PrayType.MORNING, new RelativeTime(RelativeTimeType.DAWN, 72),
                PrayDayType.MONDAY));
        synagogues.add(s);
        ...
        s.addMinyan(new Minyan("1", PrayType.AFTER_NOON, new ExactTime(12,0),
        ...
        s.addMinyan(new Minyan("1", PrayType.EVENING, new RelativeTime(RelativeTimeType.SUNSET,-12),
                PrayDayType.TUESDAY));
        synagogues.add(s);
        ...
        s.addMinyan(new Minyan("1", PrayType.MORNING, new RelativeTime(RelativeTimeType.SUNSET,0),
                PrayDayType.FRIDAY));
        synagogues.add(s);
